  ...
  <div className={styles.content}>
    <div className={styles.main}>
      <div className={styles.form}>
        ...
        <div className={styles.saveKeyText}>{props.text}</div>
        {props.proceedAsLink ? (
...
SaveKey.defaultProps = {
  text: <span>This is your Social Private Key.<br /><strong>You will need it to authorize on a platform</strong> from any device. Keep it safe.</span>,
  proceedAsLink: true,
  onCopy: undefined,
};
